...
run:
	...
	docker run -d -e ENV_DOCKER_REGISTRY_HOST=0.0.0.0.5000 -e ENV_DOCKER_REGISTRY_PORT=5000 -p 0.0.0.0:5001:80 --name $(FRONTEND) $(IMG_SOURCE)konradkleine/docker-registry-frontend:v1-deprecated
